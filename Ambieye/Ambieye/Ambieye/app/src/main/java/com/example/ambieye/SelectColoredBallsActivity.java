...
public class SelectColoredBallsActivity extends AppCompatActivity {
    ...
    private String[] colorsToFind = {"Red", "Green", "Blue", "Yellow"};
    private int[] colorResources = {R.drawable.ball_red, R.drawable.ball_green, R.drawable.ball_blue, R.drawable.ball_yellow};
