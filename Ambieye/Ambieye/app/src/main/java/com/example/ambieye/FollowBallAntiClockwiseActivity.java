...
public class FollowBallAntiClockwiseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_follow_ball_anti_clockwise);
    ...
    private void startAnimation() {
        animationCanvas.post(() -> {
            ...
            animator = ValueAnimator.ofFloat(0, (float) (-2 * Math.PI)); // Negative for anti-clockwise
